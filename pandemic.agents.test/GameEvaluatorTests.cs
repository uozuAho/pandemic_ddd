...
internal class GameEvaluatorTests
{
    ...
    public void Closer_to_high_cube_cities_is_better()
    {
        ...
        game = game with
        {
            Cities = game.Cities.Replace(
                ...
                atlanta with
                {
                    Cubes = atlanta.Cubes.AddCubes(Colour.Blue, 3),
                }
            ),
        };

        var gameClose = game with
        {
            Players = game.Players.Add(new Player { Location = "Chicago" }),
        };
    ...
    public void Spread_players_to_cubes(int numCubes)
    {
        ...
        {
            Cities = game
                .Cities.Replace(atlanta, atlanta.AddCubes(Colour.Blue, numCubes))
        ...
        {
            Players = game
                .Players.Add(new Player { Location = "Chicago" })
    ...
    public void When_player_has_enough_cards_to_cure__closer_to_station_is_better()
    {
        ...
        var atChicago = game with
        {
            Players = game.Players.Add(player with { Location = "Chicago" }),
        };
    ...
    public void Prefer_spread_research_stations()
    {
        ...
        {
            Cities = game
                .Cities.Replace(atlanta, atlanta with { HasResearchStation = true })
