...
public static class StandardGameBoard
{
    ...
    public static bool IsCity(string city)
    {
        return CityLookup.ContainsKey(city);
    }

    public static CityData City(string name)
    {
    ...
    public static int CityIdx(string name)
    {
        return CityIdxLookup[name];
    }

    public static readonly Dictionary<string, List<string>> AdjacentCities;

    public static int[] AdjacentCityIdxs(int cityIdx)
    {
        return AdjacencyIdxsLookup[cityIdx];
    }

    public static bool IsAdjacent(string city1, string city2)
    {
    ...
    {
        return DistanceLookup[(city1, city2)];
    }
    ...
    private static readonly List<(string, string)> Edges =
    [
        ("Algiers", "Cairo"),
        ("Algiers", "Istanbul"),
        ("Algiers", "Madrid"),
