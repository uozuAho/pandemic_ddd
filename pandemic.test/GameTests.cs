...
internal sealed class GameTests
{
    ...
    public void Drive_or_ferry_to_garbage_city_throws()
    {
        ...
        _ = Assert.Throws<InvalidActionException>(() =>
    ...
    public void Drive_or_ferry_to_non_adjacent_city_throws()
    {
        ...
        _ = Assert.Throws<GameRuleViolatedException>(() =>
    ...
    public void Charter_flight_to_garbage_city_throws()
    {
        ...
        _ = Assert.Throws<InvalidActionException>(() =>
            game.Do(
                new CharterFlightCommand(Role.Medic, PlayerCards.CityCard("Atlanta"), "fasdfasdf")
            )
        );
    }
    ...
    public void Charter_flight_to_current_location_throws()
    {
        ...
        _ = Assert.Throws<GameRuleViolatedException>(() =>
            game.Do(
                new CharterFlightCommand(Role.Medic, PlayerCards.CityCard("Atlanta"), "Atlanta")
            )
        );
    }
    ...
    public void Charter_flight_when_not_turn_throws()
    {
        ...
        _ = Assert.Throws<GameRuleViolatedException>(() =>
            game.Do(
                new CharterFlightCommand(Role.Scientist, PlayerCards.CityCard("Atlanta"), "Bogota")
            )
        );
    }
    ...
    public void Shuttle_flight_throws_if_location_has_no_research_station()
    {
        ...
        {
            Cities = game
                .Cities.Replace(atlanta, atlanta with { HasResearchStation = false })
                .Replace(bogota, bogota with { HasResearchStation = true }),
        };
    ...
    public void Player_draws_two_cards_after_last_action()
    {
        ...
        var game = startingState.SetCurrentPlayerAs(
            startingState.CurrentPlayer with
            {
                ActionsRemaining = 1,
            }
        );
    ...
    public void Cities_are_infected_after_player_turn_ends()
    {
        ...
        game.InfectionDrawPile.Count.ShouldBe(
            startingState.InfectionDrawPile.Count - game.InfectionRate
        );
        game.InfectionDiscardPile.Count.ShouldBe(
            startingState.InfectionDiscardPile.Count + game.InfectionRate
        );
    ...
    {
        var game = DefaultTestGame() with { Cubes = CubePile.Empty };
    ...
    public void It_is_next_players_turn_after_infect_cities()
    {
        ...
        game.PlayerByRole(Role.Medic)
            .ActionsRemaining.ShouldBe(
                4,
    ...
    public void Player_must_discard_when_hand_is_full()
    {
        ...
        foreach (
            var command in AllPlayerCommandGenerator
                .AllPossibleCommands(game)
                .Where(c => c.ConsumesAction)
        )
        {
            Assert.That(
                () => game.Do(command),
    ...
    public void Discard_player_card_goes_to_discard_pile()
    {
        ...
        game = game with { PlayerDrawPile = game.PlayerDrawPile.RemoveIfPresent(top7Cards) };
        game = game.SetCurrentPlayerAs(
            game.CurrentPlayer with
            {
                ActionsRemaining = 1,
    ...
    public void Discard_player_card_when_no_actions_infects_cities()
    {
        ...
        var game = initialGame.SetCurrentPlayerAs(
            initialGame.CurrentPlayer with
            {
                ActionsRemaining = 0,
        ...
        (game, _) = game.Do(
            new DiscardPlayerCardCommand(
                game.CurrentPlayer.Role,
                game.CurrentPlayer.Hand.Cards.First()
            )
        );
    ...
    public void Scenario_share_knowledge_give_then_other_player_must_discard()
    {
        ...
        game = game.Do(
            new ShareKnowledgeGiveCommand(Role.Medic, "Atlanta", Role.Scientist),
            events
        );
        ...
        game = game.Do(
            new DiscardPlayerCardCommand(Role.Scientist, PlayerCards.CityCard("Miami")),
            events
        );
    ...
    public void Scenario_share_knowledge_take_then_other_player_must_discard()
    {
        ...
        var gameStateBeforeShare = game;
        game = game.Do(
            new ShareKnowledgeTakeCommand(Role.Medic, "Atlanta", Role.Scientist),
            events
        );
        ...
        game = game.Do(
            new DiscardPlayerCardCommand(Role.Medic, PlayerCards.CityCard("Miami")),
            events
        );
    ...
    public void Scenario_share_knowledge_at_end_of_turn_when_both_players_hands_are_full()
    {
        ...
        var scientistHand = PlayerHand.Of(
            "Miami",
            "Taipei",
            "Sydney",
            "Delhi",
        ...
        game = game with
        {
            PlayerDrawPile = new Deck<PlayerCard>(
                game.PlayerDrawPile.Cards.Where(c =>
                    !medicHand.Contains(c) && !scientistHand.Contains(c)
                )
            ),
        };
        ...
        game = game.Do(
            new ShareKnowledgeGiveCommand(Role.Medic, cardToShare.City.Name, Role.Scientist),
            events
        );
        ...
        game = game.Do(
            new DiscardPlayerCardCommand(Role.Medic, PlayerCards.CityCard("Moscow")),
            events
        );
    ...
    public void Build_research_station_can_end_turn()
    {
        ...
        AssertEndsTurn(() =>
            game.Do(new BuildResearchStationCommand(game.CurrentPlayer.Role, "Chicago"))
        );
    }
    ...
    public void Build_research_station_without_correct_city_card_throws()
    {
        ...
        _ = Assert.Throws<GameRuleViolatedException>(() =>
            game.Do(new BuildResearchStationCommand(game.CurrentPlayer.Role, "Atlanta"))
        );
    }
    ...
    {
        var game = DefaultTestGame().Cure(Colour.Blue).Cure(Colour.Red).Cure(Colour.Yellow);
    ...
    public void Cure_last_disease_on_last_action_wins()
    {
        var game = DefaultTestGame() with
        {
            CuresDiscovered =
            [
                new(Colour.Blue, CureMarkerSide.Vial),
                new(Colour.Red, CureMarkerSide.Vial),
                new(Colour.Yellow, CureMarkerSide.Vial),
            ],
        };
    ...
    public void Cure_when_not_enough_cards_throws()
    {
        ...
        game = game.SetCurrentPlayerAs(
            game.CurrentPlayer with
            {
                Location = "Atlanta",
                Hand = new PlayerHand(
                    PlayerCards.CityCards.Where(c => c.City.Colour == Colour.Black).Take(4)
                ),
            }
        );
    ...
    public void Cure_already_cured_disease_throws()
    {
        var game = DefaultTestGame() with
        {
            CuresDiscovered = [new(Colour.Black, CureMarkerSide.Vial)],
        };
    ...
    public void Epidemic_after_7_cards_in_hand()
    {
        ...
        game = game.Do(
            new DiscardPlayerCardCommand(
                game.CurrentPlayer.Role,
                game.CurrentPlayer.Hand.CityCards().First()
            ),
            events
        );
    ...
    public void Treat_disease()
    {
        ...
        // act
        (game, _) = game.Do(
            new TreatDiseaseCommand(game.CurrentPlayer.Role, "Atlanta", Colour.Blue)
        );
    ...
    public void Treat_disease_removes_all_cubes_when_cured()
    {
        var game = DefaultTestGame(
            ...
            {
                Roles = new[] { Role.Researcher, Role.QuarantineSpecialist },
            }
        );
        var atlanta = game.CityByName("Atlanta");
    ...
    public void Share_knowledge_take_works()
    {
        ...
        // act
        (game, _) = game.Do(
            new ShareKnowledgeTakeCommand(game.CurrentPlayer.Role, "Atlanta", Role.Scientist)
        );
    ...
    public void Epidemic()
    {
        ...
        _ = game.PlayerDiscardPile.TopCard.ShouldBeOfType<EpidemicCard>();
    }
    ...
    public void Epidemic_onto_existing_cube_causes_outbreak()
    {
        ...
        game = game with
        {
            ...
            Cities = game.Cities.Replace(
                epidemicCity,
                epidemicCity.AddCube(epidemicInfectionCard.Colour)
            ),
        };
        game = game.SetCurrentPlayerAs(game.CurrentPlayer with { ActionsRemaining = 1 });
        ...
        game.CityByName(epidemicInfectionCard.City)
            .Cubes.NumberOf(epidemicInfectionCard.Colour)
            .ShouldBe(3);
    ...
    public void Epidemic_onto_multiple_existing_cubes_causes_outbreak()
    {
        ...
        game = game.RemoveAllCubesFromCities()
    ...
    public void Epidemic_double()
    {
        ...
        game = game.RemoveAllCubesFromCities() with
        {
            PlayerDrawPile = game.PlayerDrawPile.PlaceOnTop(new EpidemicCard(), new EpidemicCard()),
        };
        game = game.SetCurrentPlayerAs(game.CurrentPlayer with { ActionsRemaining = 1 });
        ...
        game.CityByName(epidemicInfectionCard1.City)
            .Cubes.NumberOf(epidemicInfectionCard1.Colour)
            .ShouldBe(3);
        game.CityByName(epidemicInfectionCard2.City)
            .Cubes.NumberOf(epidemicInfectionCard2.Colour)
            .ShouldBe(3);
    ...
    public void Eradicate_causes_infection_cards_to_have_no_effect()
    {
            ...
            .Cure(Colour.Blue) with
        {
            ...
            InfectionDrawPile = new Deck<InfectionCard>(
                game.InfectionDrawPile.Cards.Where(c => c.Colour == Colour.Blue)
            ),
        };
        game = game.SetCurrentPlayerAs(game.CurrentPlayer with { ActionsRemaining = 1 });
        ...
        game.Cities.ShouldNotContain(
            c => c.Cubes.NumberOf(Colour.Blue) > 0,
    ...
    public void Outbreak_infects_adjacent_cities()
    {
        ...
        game = game.RemoveAllCubesFromCities().AddCubes("Atlanta", Colour.Blue, 3) with
        {
            InfectionDrawPile = game
                .InfectionDrawPile.RemoveIfPresent(atlantaInfectionCard)
        ...
        var adjacentCities = StandardGameBoard
            .AdjacentCities["Atlanta"]
            .Select(a => game.CityByName(a));
    ...
    public void Outbreak_x8_causes_loss()
    {
        ...
        game = game with
        {
            ...
            InfectionDrawPile = game.InfectionDrawPile.PlaceOnTop(
                InfectionCard.FromCity(StandardGameBoard.City("Atlanta"))
            ),
            Cities = game.Cities.Replace(
                atlanta,
                atlanta with
    ...
    public void Outbreak_scenario_chain_reaction()
    {
        ...
        {
            InfectionDrawPile = game
                .InfectionDrawPile.RemoveIfPresent(atlanta)
                .PlaceOnTop(atlanta)
    ...
    public void Outbreak_scenario_chain_reaction_big()
    {
        ...
        game.Cities.ShouldAllBe(c =>
            ColourExtensions.AllColours.All(col =>
                c.Cubes.NumberOf(col) >= 0 && c.Cubes.NumberOf(col) <= 3
            )
        );
    }
    ...
    public void Government_grant_builds_station_without_using_action()
    {
        ...
        PlayerCommandGenerator
            ...
            .ShouldContain(
                ...
                47,
                "one for each city except Atlanta"
            );
        ...
        game.ResearchStationPile.ShouldBe(4);
        _ = game.PlayerDiscardPile.TopCard.ShouldBeOfType<GovernmentGrantCard>();
    }
    ...
    public void Government_grant_on_existing_research_station_throws()
    {
        ...
        game = game with
        {
            Cities = game.Cities.Replace(chicago, chicago with { HasResearchStation = true }),
        };
        game = game.SetCurrentPlayerAs(
            game.CurrentPlayer with
            {
        ...
        _ = Should.Throw<GameRuleViolatedException>(() =>
            game.Do(new GovernmentGrantCommand(Role.Medic, "Chicago"))
        );
    }
    ...
    public void Government_grant_can_play_when_not_your_turn()
    {
        ...
        game = game.SetPlayer(
            ...
            scientist with
            {
                Hand = scientist.Hand.Add(new GovernmentGrantCard()),
            }
        );
    ...
    public void Government_grant_can_use_instead_of_discarding()
    {
        ...
        game = game.SetCurrentPlayerAs(
            game.CurrentPlayer with
            {
                ActionsRemaining = 1,
                Hand = new PlayerHand(
                    game.PlayerDrawPile.Bottom(5).Concat(new[] { new GovernmentGrantCard() })
                ),
            }
        );
    ...
    public static object[] AllSpecials_EpidemicFirst = SpecialEventCards
        .All.Select(card => new object[] { card, true })
        .ToArray();
    public static object[] AllSpecials_EpidemicSecond = SpecialEventCards
        .All.Select(card => new object[] { card, false })
        .ToArray();

    [TestCaseSource(nameof(AllSpecials_EpidemicFirst))]
    [TestCaseSource(nameof(AllSpecials_EpidemicSecond))]
    public void Dont_use_special_event_during_epidemic(
        PlayerCard eventCard,
        bool epidemicCardIsFirst
    )
    {
        var game = DefaultTestGame();
        ...
        game = game.RemoveAllCubesFromCities() with
        {
            PlayerDrawPile = epidemicCardIsFirst
                ...
                : game
                    .PlayerDrawPile.Remove(game.PlayerDrawPile.TopCard)
    ...
    public void Dont_use_special_during_turn_should_throw(PlayerCard eventCard)
    {
        ...
        _ = Should.Throw<GameRuleViolatedException>(() =>
            game.Do(new DontUseSpecialEventCommand())
        );
    }
    ...
    [TestCaseSource(nameof(AllSpecialEventCards))]
    public void Dont_use_special_event_after_turn_when_other_player_has_event_card(
        PlayerCard eventCard
    )
    {
        var game = DefaultTestGame();
    ...
    public void Event_forecast_happy_path()
    {
        ...
        _ = game.PlayerDiscardPile.TopCard.ShouldBeOfType<EventForecastCard>();
    }
    ...
    public void Event_forecast_throws_if_cards_are_not_at_top_of_infection_deck()
    {
        ...
        var cardsToReorder = game
            .InfectionDrawPile.Top(5)
            .Concat(game.InfectionDrawPile.Bottom(1))
            .ToImmutableList();
    ...
    public void Airlift_happy_path()
    {
        ...
        (game, var events) = game.Do(
            new AirliftCommand(game.CurrentPlayer.Role, game.CurrentPlayer.Role, "Paris")
        );

        game.CurrentPlayer.Location.ShouldBe("Paris");
        game.CurrentPlayer.ActionsRemaining.ShouldBe(4);
        game.CurrentPlayer.Hand.Cards.ShouldNotContain(c => c is AirliftCard);
        _ = game.PlayerDiscardPile.TopCard.ShouldBeOfType<AirliftCard>();
    }
    ...
    public void Airlift_can_move_any_pawn()
    {
        ...
        (game, var events) = game.Do(
            new AirliftCommand(game.CurrentPlayer.Role, otherPlayer, "Paris")
        );
    ...
    public void Resilient_population_happy_path()
    {
        ...
        (game, var events) = game.Do(
            new ResilientPopulationCommand(game.CurrentPlayer.Role, infectionCardToRemove)
        );
        ...
        _ = game.PlayerDiscardPile.TopCard.ShouldBeOfType<ResilientPopulationCard>();
    }
    ...
    public void Resilient_population_throws_if_not_in_hand()
    {
        ...
        _ = Should.Throw<GameRuleViolatedException>(() =>
            game.Do(
                new ResilientPopulationCommand(
                    game.CurrentPlayer.Role,
                    game.InfectionDiscardPile.TopCard
                )
            )
        );
    }
    ...
    public void Resilient_population_throws_if_infection_card_is_not_in_discard_pile()
    {
        ...
        _ = Should.Throw<GameRuleViolatedException>(() =>
            game.Do(
                new ResilientPopulationCommand(
                    game.CurrentPlayer.Role,
                    game.InfectionDrawPile.TopCard
                )
            )
        );
    }
    ...
    public void One_quiet_night_happy_path()
    {
        ...
        _ = game.PlayerDiscardPile.TopCard.ShouldBeOfType<OneQuietNightCard>();
    }
    ...
    public void One_quiet_night_throws_if_not_in_hand()
    {
        ...
        _ = Should.Throw<GameRuleViolatedException>(() =>
            game.Do(new OneQuietNightCommand(game.CurrentPlayer.Role))
        );
    }
    ...
    public void Dispatcher_moves_self_to_other_pawn()
    {
        ...
        game = game with
        {
            Players = game.Players.Replace(medic, medic with { Location = "Paris" }),
        };
        var events = new List<IEvent>();

        game = game.Do(
            new DispatcherMovePawnToOtherPawnCommand(Role.Dispatcher, Role.Medic),
            events
        );
    ...
    public void Dispatcher_moves_other_pawn_to_self()
    {
        ...
        game = game.Do(
            new DispatcherMovePawnToOtherPawnCommand(Role.Medic, Role.Dispatcher),
            events
        );
    ...
    public void Dispatcher_moves_other_pawn_to_other_pawn()
    {
        ...
        {
            Players = game
                .Players.Replace(medic, medic with { Location = "Paris" })
                .Replace(scientist, scientist with { Location = "Bogota" }),
        };
        var events = new List<IEvent>();

        game = game.Do(
            new DispatcherMovePawnToOtherPawnCommand(Role.Medic, Role.Scientist),
            events
        );
    ...
    public void Dispatcher_shuttle_fly_other_pawn()
    {
        ...
        game = game with
        {
            Cities = game.Cities.Replace(moscow, moscow with { HasResearchStation = true }),
        };
        var events = new List<IEvent>();
    ...
    public void Dispatcher_shuttle_fly_other_pawn_throws_if_not_on_research_station()
    {
        ...
        game = game.SetPlayer(
            Role.Medic,
            game.PlayerByRole(Role.Medic) with
            {
                Location = "Chicago",
            }
        );
    ...
    public void Operations_expert_builds_research_station_without_card()
    {
        var game = DefaultTestGame(
            DefaultTestGameOptions() with
            {
                Roles = new[] { Role.OperationsExpert, Role.Medic },
            }
        );
    ...
    public void Operations_expert_builds_research_station_throws_when_already_station()
    {
        ...
        _ = Should.Throw<GameRuleViolatedException>(() =>
            game.Do(new OperationsExpertBuildResearchStation(), events)
        );
    }
    ...
    public void Operations_expert_moves_from_station_to_anywhere_only_once_per_turn()
    {
        ...
        game = game.SetCurrentPlayerAs(
            game.CurrentPlayer with
            {
                Hand = PlayerHand.Of(chicagoCard, sydneyCard),
            }
        );
        game = game with
        {
            ...
            PlayerDrawPile = game
                .PlayerDrawPile.RemoveIfPresent(chicagoCard)
                .RemoveIfPresent(sydneyCard),
        };
        var events = new List<IEvent>();
    ...
    {
        var game = DefaultTestGame();
        game = game.Cure(Colour.Blue).RemoveAllCubesFromCities().AddCube("Chicago", Colour.Blue);
        var startingBlueCubes = game.Cubes.NumberOf(Colour.Blue);
    ...
    public void Medic_auto_removes_cubes_when_cured__airlift()
    {
        var game = DefaultTestGame(
            DefaultTestGameOptions() with
            {
                Roles = new[] { Role.Researcher, Role.Medic },
            }
        );
        game = game.Cure(Colour.Blue)
            .RemoveAllCubesFromCities()
        ...
        var startingBlueCubes = game.Cubes.NumberOf(Colour.Blue);
        (game, _) = game.Do(new AirliftCommand(Role.Researcher, Role.Medic, "Chicago"));
    ...
    public void Medic_auto_removes_cubes_when_cured__direct_flight()
    {
        ...
        var startingBlueCubes = game.Cubes.NumberOf(Colour.Blue);
        (game, _) = game.Do(new DirectFlightCommand(game.CurrentPlayer.Role, "Chicago"));
    ...
    public void Medic_auto_removes_cubes_when_cured__charter_flight()
    {
        ...
        var startingBlueCubes = game.Cubes.NumberOf(Colour.Blue);
        (game, _) = game.Do(new CharterFlightCommand(game.CurrentPlayer.Role, atlanta, "Chicago"));
    ...
    public void Medic_auto_removes_cubes_when_cured__dispatcher_charter_flight()
    {
        ...
        game = game.Cure(Colour.Blue)
            ...
            .SetCurrentPlayerAs(game.CurrentPlayer with { Hand = PlayerHand.Of(atlanta) });
        var startingBlueCubes = game.Cubes.NumberOf(Colour.Blue);
        (game, _) = game.Do(new DispatcherCharterFlyPawnCommand(Role.Medic, "Chicago"));
    ...
    public void Medic_auto_removes_cubes_when_cured__dispatcher_direct_flight()
    {
        ...
        game = game.Cure(Colour.Blue)
            ...
            .SetCurrentPlayerAs(game.CurrentPlayer with { Hand = PlayerHand.Of("Chicago") });
        var startingBlueCubes = game.Cubes.NumberOf(Colour.Blue);
        (game, _) = game.Do(new DispatcherDirectFlyPawnCommand(Role.Medic, "Chicago"));
    ...
    public void Medic_auto_removes_cubes_when_cured__dispatcher_shuttle()
    {
        ...
        var startingBlueCubes = game.Cubes.NumberOf(Colour.Blue);
        (game, _) = game.Do(new DispatcherShuttleFlyPawnCommand(Role.Medic, "Chicago"));
    ...
    public void Medic_auto_removes_cubes_when_cure_is_discovered()
    {
        ...
        game = game.RemoveAllCubesFromCities().AddCube("Chicago", Colour.Blue);
        game = game.SetCurrentPlayerAs(
            game.CurrentPlayer with
            {
    ...
    {
        var game = DefaultTestGame().RemoveAllCubesFromCities().Cure(Colour.Blue);
        game = game with
        {
            InfectionDrawPile = game.InfectionDrawPile.PlaceOnTop(
    ...
    {
        var game = DefaultTestGame();
        game = game.Eradicate(Colour.Blue)
            .RemoveAllCubesFromCities()
            .AddCube("Chicago", Colour.Blue);
    ...
    public void Quarantine_specialist_prevents_outbreak_infection_when_in_adjacent_city()
    {
        ...
        // act
        (game, _) = game.Do(new PassCommand(Role.QuarantineSpecialist));
    ...
    [TestCase("Atlanta")]
    [TestCase("Chicago")]
    public void Quarantine_specialist_prevents_outbreak_when_epidemic_causes_outbreak(
        string quarantineSpecialistLocation
    )
    {
        var game = DefaultTestGame(
            DefaultTestGameOptions() with
        ...
        game = game.SetCurrentPlayerAs(
            game.CurrentPlayer with
            {
                Location = quarantineSpecialistLocation,
            }
        );
    ...
    public void Scientist_cure_throws_if_not_enough_cards()
    {
        ...
        game = game.SetCurrentPlayerAs(
            ...
            {
                Hand = new PlayerHand(
                    PlayerCards.CityCards.Where(c => c.City.Colour == Colour.Black).Take(3)
                ),
            }
        );
    ...
    public void Contingency_planner_can_take_event_card_from_discard_pile_and_use_it()
    {
        ...
        // act: take card
        (game, _) = game.Do(new ContingencyPlannerTakeEventCardCommand(airlift));
    ...
    public void Contingency_planner_can_use_one_quiet_night()
    {
        ...
        (
            (ContingencyPlanner)game.PlayerByRole(Role.ContingencyPlanner)
        ).StoredEventCard.ShouldBeNull();
    ...
    public void Contingency_planner_can_use_resilient_population()
    {
        ...
        // act
        game = game.Do(
            new ResilientPopulationCommand(Role.ContingencyPlanner, infectionCardToRemove),
            events
        );
    ...
    public void Contingency_planner_can_use_event_forecast()
    {
        ...
        // act
        game = game.Do(
            new EventForecastCommand(Role.ContingencyPlanner, infectionCardOrder),
            events
        );
